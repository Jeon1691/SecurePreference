package bootpay.co.kr.securepref.model

import android.provider.Settings
import bootpay.co.kr.securepref.SecurePreference
import bootpay.co.kr.securepref.security.AesCbc
import bootpay.co.kr.securepref.security.EncryptedPreference
import bootpay.co.kr.securepref.security.PrefInject
import bootpay.co.kr.securepref.type.*
...
abstract class PrefModel {
    ...
    protected fun blockingCommitBulkEdit() {
        editor.commit()
        inTransaction.set(false)
    }
